...
class user {
    ...
    init() {
        ...
        const proxies = [
            'http://kSFUDLN3iuAG0Qg:cPT1FRlZm97k5E0@204.252.82.22:49866',
            'http://nsmkhhdy:npotbget1wbs@31.59.20.176:6754',
            'http://nsmkhhdy:npotbget1wbs@23.95.150.145:6114',
            'http://nsmkhhdy:npotbget1wbs@198.23.239.134:6540',
            'http://nsmkhhdy:npotbget1wbs@45.38.107.97:6014',
            'http://nsmkhhdy:npotbget1wbs@107.172.163.27:6543',
            'http://nsmkhhdy:npotbget1wbs@198.105.121.200:6462',
            'http://nsmkhhdy:npotbget1wbs@216.10.27.159:6837',
            'http://nsmkhhdy:npotbget1wbs@142.111.67.146:5611',
            'http://nsmkhhdy:npotbget1wbs@191.96.254.138:6185',
            'http://nsmkhhdy:npotbget1wbs@31.58.9.4:6077'
        ];

        proxies.forEach((proxy, index) => {
            setTimeout(() => this.start(proxy, 'http'), index * 50);
        });
    ...
    start(proxy, proxytype) {
        switch (this.origin) {
            ...
            case 'https://astrio.io':
                this.bots.push(new (require('./protocols/astrio'))(this, proxy, proxytype))
                break
            default:
